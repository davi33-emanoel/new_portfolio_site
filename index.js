...
imagemClima.addEventListener('click',()=>{
    window.open("https://github.com/davi33-emanoel/monitor-climatico-js",'_blank')
})
...
imagemCalc.addEventListener('click',()=>{
    window.open("https://github.com/davi33-emanoel/Calculadora-de-Emprestimos_JavaScript",'_blank')
})
